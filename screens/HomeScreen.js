        ...
        <>
            ...
            >
              <View className='p-7 flex-row'>
                ...
                <TextInput
                  placeholder='DKK'
                  onChangeText={(text) =>
                    dispatch(setCurrentSavings(Number(text)))
                  }
            ...
            >
              <View className='p-7 flex-row items-center'>
                ...
                <TextInput
                  placeholder='DKK'
                  onChangeText={(text) =>
                    dispatch(setAmountYears(Number(text)))
                  }
                  onSubmitEditing={Keyboard.dismiss}
                  keyboardType='numeric'
                  className='bg-white rounded-md p-2'
          ...
          <View className='flex-1'>
            <Text className='text-gray-500 text-sm mx-5'>
              Afkast er baseret på det gns. årlige afkast for globale aktier
              over de sidste 10 år. Afkast vil variere og al investering
              medfører risiko. Der er ikke medregnet skat og beløbet herunder er
              summen af dine indskud og afkastet.
            </Text>
          </View>
          <TouchableOpacity
